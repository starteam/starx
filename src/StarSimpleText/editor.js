...
define(["require", "exports", "../StarX/lib/knockout", "../StarSimpleText/editor.soy", 'jquery', "../StarSimpleText/main"], function(require, exports, kout, editor, $, main) {
    var ko = kout.ko;
    ...
    var StarSimpleTextEditor = (function () {
        function StarSimpleTextEditor() {
        }
        StarSimpleTextEditor.prototype.configure = function (config) {
            window['knockout'] = ko;
        ...
        return StarSimpleTextEditor;
    })();
    exports.StarSimpleTextEditor = StarSimpleTextEditor;
});
